    ...
    <div className="relative min-h-screen w-full">
      ...
      {!isMenuOpen && (
        <div className="z-10 absolute w-full flex flex-col items-center mt-[-15vh]" style={{ top: '50%' }}>
          <motion.h1 
            className="text-8xl mb-8 font-bold text-center text-black "
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="fixed left-0 top-0 h-full w-[30%] bg-white flex flex-col items-center justify-center"
          ...
          >
            ...
            <div className="w-full flex flex-col items-center px-8">
              <motion.h2 
                className={`text-6xl font-bold tracking-wide mb-12 text-black text-center`}
              ...
              <div className="space-y-8 flex flex-col items-center w-full">
                {menuItems.map((item, index) => (
                  <div key={index} className="relative w-full">
                    ...
                    >
                      <button
                        className={`${fp.className} text-2xl text-black hover:text-gray-600 transition-colors`}
                      ...
                      {hoveredItem === index && (
                        <motion.div
                          className="absolute -left-4 top-1/2 w-2 h-2 bg-black rounded-full"
                          layoutId="menuDot"
                          transition={{
                            type: "spring",
                            stiffness: 300,
                      ...
                      <motion.div
                        className="absolute -bottom-2 left-0 h-0.5 bg-black w-full origin-left"
                        initial={{ scaleX: 0 }}
                        animate={{ 
